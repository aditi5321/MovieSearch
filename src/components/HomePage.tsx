      ...
      <div className='container mx-auto min-h-[calc(100vh-77px)] flex items-center relative'>
        <div className="flex-col lg:flex-row flex gap-10 lg-mx-10 py-20">
          ...
          <div className="space-y-6">
            ...
            <div className="inline-block pt-6 curser-pointer" onClick={() => setShowPlayer(true)}>
              <div className="flex gap-2 item-center px-4 py-2 mb-6 bg-blue-100 hover:bg-blue-400 rounded">
                <BsPlayFill size={24} />
                Watch Trailer
              </div>
